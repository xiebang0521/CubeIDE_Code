...
#define CBC
uint8_t iv_key[16] = {0x0f, 0x0e, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x00};
 ...
 * @return null
 */
static void mixColumns(uint8_t *state,const uint8_t *constant)
{
    uint8_t temp[4][4];
